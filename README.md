...
2) Se a senha possui pelo menos um caractere em maiúsculo

3) Se a senha possui pelo menos um caractere em minúsculo

4) Se a senha possui pelo menos um dos caractere especial (Ex.: @, #, $, %, &, *)

5) Se a senha possui pelo menos um número
